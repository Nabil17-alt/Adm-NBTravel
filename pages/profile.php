      ...
      <div class="container py-2">
        <nav aria-label="breadcrumb">
          <div class="d-flex align-items-center">
            <a href="../NBTravel/index.html" target="_blank"><span class="px-3 font-weight-bold text-lg text-white me-4">NBTravel</span></a>
          </div>
        </nav>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <ul class="navbar-nav ms-md-auto  justify-content-end">
            ...
            <li class="nav-item px-3 d-flex align-items-center">
              <a href="wgoogle.html" class="nav-link text-white p-0">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="../assets/img/tim1.jpg" class="avatar avatar-sm  me-3 " alt="user image">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">Pesan baru</span> dari Amel
                        </h6>
            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
              <div class="avatar avatar-sm position-relative">
                <img src="../assets/img/tim1.jpg" alt="profile_image" class="w-100 border-radius-md">
              </div>
            </li>
            </a>
            </li>
        ...
        <div class="row">
          <div class="col-auto">
            <div class="avatar avatar-2xl rounded-circle position-relative mt-n7 border border-gray-100 border-4">
              <img src="../assets/img/tim1.jpg" alt="profile_image" class="w-100">
            </div>
          </div>
        ...
        <div class="col-12 col-xl-4 mb-4">
          <div class="card border shadow-xs h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0 font-weight-semibold text-lg">Pengaturan notifikasi</h6>
              <p class="text-sm mb-1">Di sini Anda dapat mengatur preferensi.</p>
            </div>
            <div class="card-body p-3">
              <h6 class="text-dark font-weight-semibold mb-1">Akun</h6>
              <ul class="list-group">
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault" checked>
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault">Kirimi saya email ketika seseorang mengikuti saya</label>
                  </div>
                </li>
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault1">
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault1">Kirimi saya email ketika seseorang menjawab postingan saya</label>
                  </div>
                </li>
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault2" checked>
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault2">Kirimi saya email ketika seseorang menyebut saya</label>
                  </div>
                </li>
              </ul>
              <h6 class="text-dark font-weight-semibold mt-2 mb-1">Aplikasi</h6>
              <ul class="list-group">
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault3">
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault3">Peluncuran dan proyek baru</label>
                  </div>
                </li>
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault4" checked>
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault4">Pembaruan produk bulanan</label>
                  </div>
                </li>
                <li class="list-group-item border-0 px-0 pb-0">
                  <div class="form-check form-switch ps-0">
                    <input class="form-check-input ms-auto" type="checkbox" id="flexSwitchCheckDefault5">
                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="flexSwitchCheckDefault5">Berlangganan Youtube</label>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div class="card-header pb-0 p-3">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm">
                  ...
                  <a class="btn btn-link text-dark mb-0 ps-1 pe-1 py-0" href="https://www.instagram.com/muhammadnabil_17/">
                    <i class="fab fa-instagram fa-lg"></i>
                  </a>
                  <a class="btn btn-link text-dark mb-0 ps-1 pe-1 py-0" href="https://www.linkedin.com/in/muhammad-nabil-377629272/">
                    <i class="fab fa-linkedin fa-lg"></i>
                  </a>
                  <a class="btn btn-link text-dark mb-0 ps-1 pe-1 py-0" href="https://github.com/Nabil17-alt">
