...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand d-flex align-items-center m-0" href=" https://nabil17-alt.github.io/NBTravel/ " target="_blank">
        <span class="font-weight-bold text-lg">NBTravel</span>
      </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 " href="../pages/sign-up.php">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="../assets/img/team-2.jpeg" class="avatar avatar-sm border-radius-sm  me-3 ">
                      </div>
            ...
            <li class="nav-item ps-2 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0">
                <img src="../assets/img/tim1.jpg" class="avatar avatar-sm" alt="avatar" />
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="d-md-flex align-items-center mb-3 mx-2">
            ...
            <h3 class="font-weight-bold mb-0">Hello, Nabil </h3>'
        ...
        <div class="position-relative overflow-hidden">
          <div class="swiper mySwiper mt-4 mb-2">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div>
                  <div class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                    <div class="full-background bg-cover" style="background-image: url('../assets/img/img-1.jpeg')"></div>
                    <div class="card-body text-start px-3 py-0 w-100">
                      <div class="row mt-12">
                        <div class="col-sm-3 mt-auto">
                          <h4 class="text-dark font-weight-bolder">#1</h4>
                          <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0"></p>
                          <h5 class="text-dark font-weight-bolder">Pekanbaru ke Padang</h5>
                        </div>
                        <div class="col-sm-3 ms-auto mt-auto">
                          <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0">Rp</p>
                          <h5 class="text-dark font-weight-bolder">190.000,00-</h5>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="swiper-slide">
                <div class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                  <div class="full-background bg-cover" style="background-image: url('../assets/img/img-2.jpeg')"></div>
                  <div class="card-body text-start px-3 py-0 w-100">
                    <div class="row mt-12">
                      <div class="col-sm-3 mt-auto">
                        <h4 class="text-dark font-weight-bolder">#2</h4>
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0"></p>
                        <h5 class="text-dark font-weight-bolder">Padang ke Pekanbaru</h5>
                      </div>
                      <div class="col-sm-3 ms-auto mt-auto">
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0">Rp</p>
                        <h5 class="text-dark font-weight-bolder">190.000,00-</h5>
              ...
              <div class="swiper-slide">
                <div class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                  <div class="full-background bg-cover" style="background-image: url('../assets/img/img-3.jpeg')"></div>
                  <div class="card-body text-start px-3 py-0 w-100">
                    <div class="row mt-12">
                      <div class="col-sm-3 mt-auto">
                        <h4 class="text-dark font-weight-bolder">#3</h4>
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0"></p>
                        <h5 class="text-dark font-weight-bolder">Bukittinggi ke Padang</h5>
                      </div>
                      <div class="col-sm-3 ms-auto mt-auto">
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0">Rp</p>
                        <h5 class="text-dark font-weight-bolder">75.000,00-</h5>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                <div class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                  <div class="full-background bg-cover" style="background-image: url('../assets/img/img-4.jpeg')"></div>
                  <div class="card-body text-start px-3 py-0 w-100">
                    <div class="row mt-12">
                      <div class="col-sm-3 mt-auto">
                        <h4 class="text-dark font-weight-bolder">#4</h4>
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0"></p>
                        <h5 class="text-dark font-weight-bolder">Pekanbaru ke Bukittinggi</h5>
                      </div>
                      <div class="col-sm-3 ms-auto mt-auto">
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0">Rp</p>
                        <h5 class="text-dark font-weight-bolder">160.000,00-</h5>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                <div class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                  <div class="full-background bg-cover" style="background-image: url('../assets/img/img-5.jpeg')"></div>
                  <div class="card-body text-start px-3 py-0 w-100">
                    <div class="row mt-12">
                      <div class="col-sm-3 mt-auto">
                        <h4 class="text-dark font-weight-bolder">#5</h4>
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0"></p>
                        <h5 class="text-dark font-weight-bolder">Padang ke Bukittinggi</h5>
                      </div>
                      <div class="col-sm-3 ms-auto mt-auto">
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0">Rp</p>
                        <h5 class="text-dark font-weight-bolder">90.000,00-</h5>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                <div class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                  <div class="full-background bg-cover" style="background-image: url('../assets/img/img-6.jpeg')"></div>
                  <div class="card-body text-start px-3 py-0 w-100">
                    <div class="row mt-12">
                      <div class="col-sm-3 mt-auto">
                        <h4 class="text-dark font-weight-bolder">#6</h4>
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0"></p>
                        <h5 class="text-dark font-weight-bolder">Bukittinggi ke Pekanbaru</h5>
                      </div>
                      <div class="col-sm-3 ms-auto mt-auto">
                        <p class="text-dark opacity-6 text-xs font-weight-bolder mb-0">Rp</p>
                        <h5 class="text-dark font-weight-bolder">150.000,00-</h5>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
          <div class="card shadow-xs border h-100">
            <div class="card-header pb-0">
              <h6 class="font-weight-semibold text-lg mb-0">Ticket sales over time</h6>
              <p class="text-sm">Here you have details about the ticket.</p>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Padang ke Pekanbaru</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-normal mb-0">Rp 190.000,00-</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Pekanbaru ke Bukittinggi</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-normal mb-0">Rp 160.000,00-</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Pekanbaru ke Padang</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Bukittinggi ke Pekanbaru</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-normal mb-0">Rp 150.000,00-</p>
                      </td>
                      <td>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="w-100">
                    ...
                    <h4 class="mb-2 font-weight-bold">Rp 56.400.000,00-</h4>
                    <div class="d-flex align-items-center">
                      <span class="text-sm text-success font-weight-bolder">
                        <i class="fa fa-chevron-up text-xs me-1"></i>10.5%
                      </span>
                      <span class="text-sm ms-1">from Rp 50.478.000,00-</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="w-100">
                    ...
                    <h4 class="mb-2 font-weight-bold">Rp 150.000,00-</h4>
                    <div class="d-flex align-items-center">
                      <span class="text-sm text-success font-weight-bolder">
                        <i class="fa fa-chevron-up text-xs me-1"></i>22%
                      </span>
                      <span class="text-sm ms-1">from Rp 117.000,00-</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card border shadow-xs mb-4">
            <div class="card-body text-start p-3 w-100">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="w-100">
                    <p class="text-sm text-secondary mb-1">Ticket Discounts</p>
                    <h4 class="mb-2 font-weight-bold">Rp 20.000,00-</h4>
                    <div class="d-flex align-items-center">
                      <span class="text-sm text-success font-weight-bolder">
                        <i class="fa fa-chevron-up text-xs me-1"></i>18%
                      </span>
                      <span class="text-sm ms-1">from Rp 16.400,00-</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card shadow-xs border">
            <div class="card-header pb-0">
              ...
              <div class="d-sm-flex align-items-center">
                <h3 class="mb-0 font-weight-semibold">Rp 56.400.000,00-</h3>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-xs text-muted text-lg-start">
                Copyright © 2024
                <a href="https://github.com/Nabil17-alt" class="text-secondary" target="_blank">Muhammad Nabil</a>.
              </div>
            </div>
            <div class="col-lg-6">
    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
            ...
            data: [450, 200, 100, 220, 500, 100, 400, 312, 111, 230, 376, 200],
            maxBarThickness: 6
          },
          {
            label: "Ticket",
            ...
            data: [200, 300, 200, 420, 400, 200, 300, 200, 301, 430, 167, 376],
            maxBarThickness: 6
          },
        ],
      },
    ...
    new Chart(ctx2, {
      ...
      data: {
        ...
        datasets: [{
            ...
            fill: true,
            data: [38901234, 51234567, 67890123, 59725101, 53012345, 58901234, 64567890, 56799863, 47890123, 61234567, 53877073, 54321098, 63456789, 56987654, 50048232, 39609956, 68901234, 60571043, 63789012, 40210123, 54321098, 44439760, 50478000, 56400000],
            maxBarThickness: 6
          ...
          },
          {
            ...
            fill: true,
            data: [34152940, 44567128, 45075197, 41234567, 36236845, 46549948, 51722952, 50678901, 44567128, 42063227, 47654321, 41896350, 47802566, 55761849, 45012345, 37890123, 53320909, 51234567, 56086729, 35316818, 47802566, 40439760, 46439760, 49632000],
            maxBarThickness: 6
          },
        ],
      },
