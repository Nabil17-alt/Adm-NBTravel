        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item mt-2">
            <div class="d-flex align-items-center nav-link">
              ...
              <span class="font-weight-normal text-md ms-2">Halaman Akun</span>
            </div>
          </li>
          ...
          <nav aria-label="breadcrumb">
            ...
            >
              <li class="breadcrumb-item text-sm">
                <a class="opacity-5 text-dark" href="javascript:;">Dasbor</a>
              </li>
              <li
            ...
            <h6 class="font-weight-bold mb-0">Dasbor</h6>
          </nav>
          <div
          ...
          >
            ...
            <ul class="navbar-nav justify-content-end">
              ...
              <li class="nav-item px-3 d-flex align-items-center">
                <a href="wgoogle.html" class="nav-link text-body p-0">
                  <svg
                    width="16"
                    height="16"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li class="mb-2">
                    ...
                    >
                      <div class="d-flex py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="text-sm font-weight-normal mb-1">
                            <span class="font-weight-bold">Laporan baru</span> oleh google
                          </h6>
                          <p
                            class="text-xs text-secondary mb-0 d-flex align-items-center"
                          >
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="d-md-flex align-items-center mb-3 mx-2">
              ...
              <button type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center mb-0" onclick="window.location.href = 'wgoogle.html';">
                <span class="btn-inner--icon">
                  <svg
                    width="16"
                    height="16"
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  ...
                  >
                    <div
                      class="full-background bg-cover"
                      style="background-image: url('../assets/img/img-2.jpeg')"
                    ></div>
                    <div class="card-body text-start px-3 py-0 w-100">
                      <div class="row mt-12">
                        <div class="col-sm-3 mt-auto">
                ...
                <div class="swiper-slide">
                  ...
                  >
                    <div
                      class="full-background bg-cover"
                      style="background-image: url('../assets/img/img-4.jpeg')"
                    ></div>
                    <div class="card-body text-start px-3 py-0 w-100">
                      <div class="row mt-12">
                        <div class="col-sm-3 mt-auto">
                ...
                <div class="swiper-slide">
                  ...
                  >
                    <div
                      class="full-background bg-cover"
                      style="background-image: url('../assets/img/img-5.jpeg')"
                    ></div>
                    <div class="card-body text-start px-3 py-0 w-100">
                      <div class="row mt-12">
                        <div class="col-sm-3 mt-auto">
                ...
                <div class="swiper-slide">
                  ...
                  >
                    <div
                      class="full-background bg-cover"
                      style="background-image: url('../assets/img/img-6.jpeg')"
                    ></div>
                    <div class="card-body text-start px-3 py-0 w-100">
                      <div class="row mt-12">
                        <div class="col-sm-3 mt-auto">
            ...
            <div class="card shadow-xs border h-100">
              <div class="card-header pb-0">
                <h6 class="font-weight-semibold text-lg mb-0">
                  Penjualan tiket dari waktu ke waktu
                </h6>
                <p class="text-sm">Di sini Anda memiliki rincian tentang tiket.</p>
                <div
                  class="btn-group"
                  role="group"
              ...
              <div class="card-body py-3">
                ...
                <button class="btn btn-white mb-0 ms-auto" onclick="window.location.href = 'wgoogle.html';">Melihat laporan</button>
              </div>
            </div>
          </div>
          <div id="screenshotArea" class="col-lg-8 col-md-6">
                ...
                <div class="d-sm-flex align-items-center mb-3">
                  <div>
                    ...
                    <p class="text-sm mb-sm-0 mb-2">
                      Ini adalah rincian tentang transaksi terakhir
                    </p>
                  </div>
                  <div class="ms-auto d-flex">
                    <button
                      type="button"
                      class="btn btn-sm btn-white mb-0 me-2" onclick="window.location.href = 'wgoogle.html';" >
                      Melihat laporan
                    </button>
                    <button
                      type="button"
            ...
            <div class="card border shadow-xs mb-4">
              <div class="card-body text-start p-3 w-100">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="w-100">
                      <p class="text-sm text-secondary mb-1">Transaksi</p>
                      <h4 class="mb-2 font-weight-bold">376</h4>
                      <div class="d-flex align-items-center">
                        <span class="text-sm text-success font-weight-bolder">
                          <i class="fa fa-chevron-up text-xs me-1"></i>55%
                        </span>
                        <span class="text-sm ms-1">dari 243</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12">
                    <div class="w-100">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <span class="text-sm ms-1">dari Rp 117.000,00-</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12">
                    <div class="w-100">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <span class="text-sm ms-1">dari Rp 16.400,00-</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-header pb-0">
                <div class="d-sm-flex align-items-center mb-3">
                  <div>
                    ...
                    <p class="text-sm mb-sm-0 mb-2">
                      Di sini Anda memiliki detail tentang saldo.
                    </p>
                  </div>
                  <div class="ms-auto d-flex">
                    <button type="button" class="btn btn-sm btn-white mb-0 me-2" onclick="window.location.href = 'wgoogle.html';">
                      Melihat laporan
                    </button>
                  </div>
                </div>
            ...
            <div class="row align-items-center justify-content-lg-between">
              <div class="col-lg-6 mb-lg-0 mb-4">
                ...
                >
                  Copyright © 2024
                  <a
                    href="https://github.com/Nabil17-alt"
          ...
          datasets: [
            {
              ...
              data: [
                450, 200, 100, 220, 500, 100, 400, 312, 111, 230, 376, 200,
              ],
              maxBarThickness: 6,
            },
            {
              ...
              data: [
                200, 300, 200, 420, 400, 200, 300, 200, 301, 430, 167, 376,
              ],
              maxBarThickness: 6,
            },
          ],
          ...
          datasets: [
            {
              ...
              fill: true,
              data: [
                38901234, 51234567, 67890123, 59725101, 53012345, 58901234,
                64567890, 56799863, 47890123, 61234567, 53877073, 54321098,
                63456789, 56987654, 50048232, 39609956, 68901234, 60571043,
                63789012, 40210123, 54321098, 44439760, 50478000, 56400000,
              ],
              maxBarThickness: 6,
            },
            {
              ...
              fill: true,
              data: [
                34152940, 44567128, 45075197, 41234567, 36236845, 46549948,
                51722952, 50678901, 44567128, 42063227, 47654321, 41896350,
                47802566, 55761849, 45012345, 37890123, 53320909, 51234567,
                56086729, 35316818, 47802566, 40439760, 46439760, 49632000,
              ],
              maxBarThickness: 6,
            },
          ],
